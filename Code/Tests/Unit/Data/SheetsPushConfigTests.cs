...
namespace RPGGame.Tests.Unit.Data
{
    public static class SheetsPushConfigTests
    {
        public static void RunAllTests()
        {
            ...
            TestApplyDefaultMaterialBuildsTabNameWhenUnset(ref testsRun, ref testsPassed, ref testsFailed);
            TestApplyDefaultVariablesTabNameWhenUnset(ref testsRun, ref testsPassed, ref testsFailed);
        ...
        private static void TestApplyDefaultOptionalTabNamesWhenAllUnset(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            ...
            TestBase.AssertEqual(SheetsPushConfig.DefaultMaterialBuildsSheetTabName, cfg.MaterialBuildsSheetTabName, "material builds", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertEqual(SheetsPushConfig.DefaultVariablesSheetTabName, cfg.VariablesSheetTabName, "variables", ref testsRun, ref testsPassed, ref testsFailed);
        ...
        private static void TestApplyDefaultConsumablesTabNameWhenUnset(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            TestBase.SetCurrentTestName(nameof(TestApplyDefaultConsumablesTabNameWhenUnset));
            var cfg = new SheetsPushConfig
            {
                SpreadsheetId = "x",
                ActionsSheetTabName = "ACTIONS",
                OAuthClientSecretsPath = "s.json",
                WeaponsSheetTabName = "WEAPONS",
                ConsumablesSheetTabName = ""
            };
            TestBase.AssertTrue(cfg.ApplyDefaultConsumablesTabNameIfUnset(), "returns true", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertEqual(SheetsPushConfig.DefaultConsumablesSheetTabName, cfg.ConsumablesSheetTabName, "consumables tab defaulted", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertTrue(!cfg.ApplyDefaultConsumablesTabNameIfUnset(), "second call no-op", ref testsRun, ref testsPassed, ref testsFailed);
        }

        private static void TestApplyDefaultTriggersTabNameWhenUnset(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            TestBase.SetCurrentTestName(nameof(TestApplyDefaultTriggersTabNameWhenUnset));
            var cfg = new SheetsPushConfig
            {
                SpreadsheetId = "x",
                ActionsSheetTabName = "ACTIONS",
                OAuthClientSecretsPath = "s.json",
                WeaponsSheetTabName = "WEAPONS",
                TriggersSheetTabName = ""
            };
            TestBase.AssertTrue(cfg.ApplyDefaultTriggersTabNameIfUnset(), "returns true", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertEqual(SheetsPushConfig.DefaultTriggersSheetTabName, cfg.TriggersSheetTabName, "triggers tab defaulted", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertTrue(!cfg.ApplyDefaultTriggersTabNameIfUnset(), "second call no-op", ref testsRun, ref testsPassed, ref testsFailed);
        }

        private static void TestApplyDefaultMaterialBuildsTabNameWhenUnset(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            TestBase.SetCurrentTestName(nameof(TestApplyDefaultMaterialBuildsTabNameWhenUnset));
            var cfg = new SheetsPushConfig
            {
                SpreadsheetId = "x",
                ActionsSheetTabName = "ACTIONS",
                OAuthClientSecretsPath = "s.json",
                WeaponsSheetTabName = "WEAPONS",
                MaterialBuildsSheetTabName = ""
            };
            TestBase.AssertTrue(cfg.ApplyDefaultMaterialBuildsTabNameIfUnset(), "returns true", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertEqual(SheetsPushConfig.DefaultMaterialBuildsSheetTabName, cfg.MaterialBuildsSheetTabName, "MATERIAL BUILDS tab defaulted", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertTrue(!cfg.ApplyDefaultMaterialBuildsTabNameIfUnset(), "second call no-op", ref testsRun, ref testsPassed, ref testsFailed);
        }

        private static void TestApplyDefaultVariablesTabNameWhenUnset(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            TestBase.SetCurrentTestName(nameof(TestApplyDefaultVariablesTabNameWhenUnset));
            var cfg = new SheetsPushConfig
            {
                SpreadsheetId = "x",
                ActionsSheetTabName = "ACTIONS",
                OAuthClientSecretsPath = "s.json",
                WeaponsSheetTabName = "WEAPONS",
                VariablesSheetTabName = ""
            };
            TestBase.AssertTrue(cfg.ApplyDefaultVariablesTabNameIfUnset(), "returns true", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertEqual(SheetsPushConfig.DefaultVariablesSheetTabName, cfg.VariablesSheetTabName, "VARIABLES tab defaulted", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertTrue(!cfg.ApplyDefaultVariablesTabNameIfUnset(), "second call no-op", ref testsRun, ref testsPassed, ref testsFailed);
        }
        ...
        private static void TestApplyMissingPushTabDefaultsLegacyJsonAllTrue(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            ...
            TestBase.AssertTrue(cfg.PushActionsTab && cfg.PushWeaponsTab && cfg.PushEnemiesTab && cfg.PushDungeonsTab && cfg.PushClassPresentationTab && cfg.PushClassActionsTab && cfg.PushSkillTreesTab && cfg.PushConsumablesTab && cfg.PushTriggersTab && cfg.PushMaterialBuildsTab && cfg.PushVariablesTab && cfg.PushFlavorTab, "all push flags true", ref testsRun, ref testsPassed, ref testsFailed);
        }
        ...
        private static void TestApplyMissingPushTabDefaultsPartialKeys(ref int testsRun, ref int testsPassed, ref int testsFailed)
        {
            ...
            TestBase.AssertTrue(cfg.PushMaterialBuildsTab, "missing pushMaterialBuildsTab → true", ref testsRun, ref testsPassed, ref testsFailed);
            TestBase.AssertTrue(cfg.PushVariablesTab, "missing pushVariablesTab → true", ref testsRun, ref testsPassed, ref testsFailed);
