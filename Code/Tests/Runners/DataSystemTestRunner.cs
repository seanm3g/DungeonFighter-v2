...
namespace RPGGame.Tests.Runners
{
    ...
    public static class DataSystemTestRunner
    {
        private static readonly (string Name, System.Action Execute)[] Suites =
        {
            ...
            ("ActionTriggerSheetColumns", () => ActionTriggerSheetColumnsTests.RunAllTests()),
            ("ActionCadenceSheetColumns", () => ActionCadenceSheetColumnsTests.RunAllTests()),
            ...
            ("VariablesSheetConverter", () => VariablesSheetConverterTests.RunAllTests()),
