...
namespace RPGGame.Tests.Runners
{
    ...
    public static class FilteredTestRunner
    {
        ...
        private static IReadOnlyList<TestSuiteEntry> BuildCatalog()
        {
            ...
            list.Add(new TestSuiteEntry("combat", "StatBonusAnimalSuffixTrigger", () => RPGGame.Tests.Unit.StatBonusAnimalSuffixTriggerTests.RunAllTests()));
            ...
            list.Add(new TestSuiteEntry("combat", "ItemTriggerScenarios", () => RPGGame.Tests.Unit.ItemTriggerScenarioTests.RunAllTests()));
