...
namespace RPGGame
{
    ...
    /// Default new characters get starter-tagged Armor.json body pieces (Shirt / shinguards; no feet) unless none are tagged; then this file / tuning can list fallback armor.
