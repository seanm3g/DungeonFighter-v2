...
namespace RPGGame.UI.ColorSystem.Applications
{
    ...
    public static class LevelUpDisplayColoredText
    {
        public static List<List<ColoredText>> BuildDisplayLines(LevelUpInfo info)
        {
            ...
            {
                lines.Add(info.AwardedSkillPoint
                    ? BuildSkillPointLine(info.SkillPointsAvailable)
                ...
                if (info.AwardedSkillPoint && info.SkillPointsAvailable > 0)
                    lines.Add(BuildUnspentSkillPointsHint());
        ...
        private static List<ColoredText> BuildSkillPointLine(int available)
        {
            var b = ColoredTextBuilder.Start();
            b.Add("Gained ", Colors.White);
            b.Add("+1 Skill Point ", ColorPalette.Success);
            b.Add("(", Colors.White);
        ...
        private static List<ColoredText> BuildUnspentSkillPointsHint()
        {
            var b = ColoredTextBuilder.Start();
            b.Add("Unspent Skill Points — open Skill Tree from the game menu to learn nodes.", ColorPalette.Warning);
            return b.Build();
        }
