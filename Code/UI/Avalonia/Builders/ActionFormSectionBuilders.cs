...
namespace RPGGame.UI.Avalonia.Builders
{
    ...
    public partial class ActionFormSectionBuilders
    {
        ...
        public void BuildBasicSection(Panel parent, ActionData action)
        {
            ...
            _ctx.Factory.AddFormField(stack, "Description", action.Description, (value) => action.Description = value, isMultiline: true, description: "Description shown on played combat cards. Strip hover lists mechanical mods.", onTextChanged: (value) => action.Description = value);
