...
namespace RPGGame.UI.Avalonia.Managers.Settings
{
    ...
    public static class SettingsPanelCatalog
    {
        public static readonly IReadOnlyList<SettingsPanelDescriptor> AllPanels = new SettingsPanelDescriptor[]
        {
            ...
            // Balance & Tuning
            new("CombatTuning", "Combat Tuning", () => new CombatTuningSettingsPanel(), SettingsContentArea.MainScroll, typeof(CombatTuningSettingsPanel), UsesHandler: true, SavesViaHandler: true, SidebarGroup: SettingsSidebarGroups.Balance, Order: 1),
            new("EnemyTuning", "Enemy Tuning", () => new EnemyTuningSettingsPanel(), SettingsContentArea.MainScroll, typeof(EnemyTuningSettingsPanel), UsesHandler: true, SavesViaHandler: true, SidebarGroup: SettingsSidebarGroups.Balance, Order: 2),
            new("Classes", "Classes", () => new ClassesSettingsPanel(), SettingsContentArea.MainScroll, typeof(ClassesSettingsPanel), UsesHandler: true, SavesViaHandler: true, SidebarGroup: SettingsSidebarGroups.Balance, Order: 3),
            new("ItemGeneration", "Item Generation", () => new ItemGenerationSettingsPanel(), SettingsContentArea.ItemGeneration, typeof(ItemGenerationSettingsPanel), UsesHandler: true, SavesViaHandler: true, SidebarGroup: SettingsSidebarGroups.Balance, Order: 4),
        ...
        public static readonly IReadOnlyList<string> HandlerSaveCategoryTags = new[]
        {
            ...
            "BalanceTuning", "ItemGeneration", "EnemyTuning", "CombatTuning", "Classes", "Audio"
        };
