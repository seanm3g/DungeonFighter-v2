...
namespace RPGGame.Data
{
    ...
    public static class SpreadsheetActionColumnUsage
    {
        private static readonly SpreadsheetColumnUsageEntry[] Registry =
        {
            ...
            new("RESERVE POOL", SpreadsheetColumnUsage.LootPools),
            new("RESERVEPOOL", SpreadsheetColumnUsage.LootPools),
            new("DS", SpreadsheetColumnUsage.RuntimeCombat),
            new("MATERIAL SCALE", SpreadsheetColumnUsage.RuntimeCombat),
            new("MATERIALSCALE", SpreadsheetColumnUsage.RuntimeCombat),
            new("CONVERT MATERIAL", SpreadsheetColumnUsage.RuntimeCombat),
            new("BONUS PER KEYWORD", SpreadsheetColumnUsage.RuntimeCombat),
            new("BONUSPERKEYWORD", SpreadsheetColumnUsage.RuntimeCombat),
            new("DT", SpreadsheetColumnUsage.RuntimeCombat),
            new("KEYWORD SCALE", SpreadsheetColumnUsage.RuntimeCombat),
            new("KEYWORDSCALE", SpreadsheetColumnUsage.RuntimeCombat),
            new("CONVERT KEYWORD", SpreadsheetColumnUsage.RuntimeCombat),
            new("EFFECT", SpreadsheetColumnUsage.RuntimeCombat),
            new("DU", SpreadsheetColumnUsage.RuntimeCombat),
            new("SCALE FORMULA", SpreadsheetColumnUsage.RuntimeCombat),
            new("SCALEFORMULA", SpreadsheetColumnUsage.RuntimeCombat),
            new("CONVERT FORMULA", SpreadsheetColumnUsage.RuntimeCombat),
            new("KEYWORD", SpreadsheetColumnUsage.RuntimeCombat),
            ...
            new("ENERGY", SpreadsheetColumnUsage.RuntimeCombat),
            new("ENERGYCOST", SpreadsheetColumnUsage.RuntimeCombat),
            new("ENERGY COST", SpreadsheetColumnUsage.RuntimeCombat),
            new("DURATION", SpreadsheetColumnUsage.RuntimeCombat),
            new("CADENCE", SpreadsheetColumnUsage.RuntimeCombat),
            new("MECHANICS", SpreadsheetColumnUsage.JsonRoundTrip),
            ...
            new("WEAPONSPEED", SpreadsheetColumnUsage.RuntimeCombat, "HEROBASE"),
            new("WEAPONDAMAGE", SpreadsheetColumnUsage.RuntimeCombat, "HEROBASE"),
            new("WEAPONSPEED", SpreadsheetColumnUsage.RuntimeCombat, "HEROBASESTATS"),
            new("WEAPONDAMAGE", SpreadsheetColumnUsage.RuntimeCombat, "HEROBASESTATS"),
            new("WEAPONSPEED", SpreadsheetColumnUsage.RuntimeCombat, "ENEMYBASE"),
            new("WEAPONDAMAGE", SpreadsheetColumnUsage.RuntimeCombat, "ENEMYBASE"),
            new("WEAPONSPEED", SpreadsheetColumnUsage.RuntimeCombat, "ENEMYBASESTATS"),
            new("WEAPONDAMAGE", SpreadsheetColumnUsage.RuntimeCombat, "ENEMYBASESTATS"),
            ...
            new("MAXHEALTH", SpreadsheetColumnUsage.RuntimeCombat, "HEROHEAL"),
            new("MAXHEALTH", SpreadsheetColumnUsage.RuntimeCombat),

            // Status (enemy target block + unscoped fallbacks)
            new("STUN", SpreadsheetColumnUsage.IngestedNotRuntime, "ENEMYTARGET"),
            new("POISON", SpreadsheetColumnUsage.IngestedNotRuntime, "ENEMYTARGET"),
            new("BURN", SpreadsheetColumnUsage.IngestedNotRuntime, "ENEMYTARGET"),
            new("BLEED", SpreadsheetColumnUsage.IngestedNotRuntime, "ENEMYTARGET"),
            new("STUN", SpreadsheetColumnUsage.IngestedNotRuntime),
            new("POISON", SpreadsheetColumnUsage.IngestedNotRuntime),
            new("BURN", SpreadsheetColumnUsage.IngestedNotRuntime),
            new("BLEED", SpreadsheetColumnUsage.IngestedNotRuntime),
            ...
            new("FORTIFY", SpreadsheetColumnUsage.RuntimeCombat),
            ...
            new("ONHIT", SpreadsheetColumnUsage.JsonRoundTrip),
            new("ONMISS", SpreadsheetColumnUsage.JsonRoundTrip),
            new("ONCRIT", SpreadsheetColumnUsage.JsonRoundTrip),
            new("ONKILL", SpreadsheetColumnUsage.JsonRoundTrip),
            new("ONROOMSCLEARED", SpreadsheetColumnUsage.RuntimeCombat),
            new("ONWIELD", SpreadsheetColumnUsage.RuntimeCombat),
            new("ONFIRSTHIT", SpreadsheetColumnUsage.RuntimeCombat),
            new("ONAFTERMISS", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFCLUTCH", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFSAMESACTION", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFDIFFERENTACTION", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFLASTENEMY", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFSOURCEUNDERDOT", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFTARGETUNDERDOT", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFSOURCESTATUS", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFTARGETSTATUS", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFACTIONHASTAG", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFGEARHASTAG", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFTARGETHASTAG", SpreadsheetColumnUsage.RuntimeCombat),
            new("IFSOURCEHEALTHBELOW", SpreadsheetColumnUsage.RuntimeCombat),
            new("ONROLLVALUE", SpreadsheetColumnUsage.RuntimeCombat),
            new("TRIGGERCONDITIONS", SpreadsheetColumnUsage.RuntimeCombat),
            new("TRIGGERBUNDLESJSON", SpreadsheetColumnUsage.JsonRoundTrip),
            // TRIGGERS band triples (SCOPE + mechanic pointers; count labels already listed above)
            new("ONHITSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONHIT→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONMISSSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONMISS→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCRITSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCRIT→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONKILLSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONKILL→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCONNECTSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCONNECT→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCOMBOSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCOMBO→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCOMBOENDSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCOMBOEND→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCRITMISSSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONCRITMISS→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONFIRSTHITSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONFIRSTHIT→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONAFTERMISSSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONAFTERMISS→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONROOMSCLEAREDSCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONROOMSCLEARED→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONROLLVALUESCOPE", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
            new("ONROLLVALUE→", SpreadsheetColumnUsage.RuntimeCombat, "TRIGGERS"),
