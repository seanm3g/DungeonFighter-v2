---
name: "source-command-balance"
description: "Migrated source command `balance`"
---

# source-command-balance

Use this skill when the user asks to run the migrated source command `balance`.
