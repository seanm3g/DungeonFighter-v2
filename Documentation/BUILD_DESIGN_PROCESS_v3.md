# Build Design Process v3

Canonical format for proposing and stress-testing class builds. Prefer this sticky schema over free-form guides.

v2’s Engine × Carrier matrix (Actions / Items / Class) remains useful when **implementing** a build. v3 is the **design card** you fill first.
...
> Using **Build Design Process v3**, propose N builds for fantasy X.  
...
**Bottom line:** v3 is a five-line closed circuit plus optional joiners. If the sticky does not close, the build is not ready — fix the card before writing systems or long guides.
