...
**See:** `Documentation/COMBAT_LOG_SPACING_STANDARD.md` (this document) and `Documentation/FORMATTING_SYSTEM_GUIDE.md`.
...
See the **Vertical Spacing Rules** section below in this document.
...
- `Documentation/FORMATTING_SYSTEM_GUIDE.md` - Text and color formatting rules
- `Documentation/QUICK_REFERENCE.md` - Key file locations and commands
