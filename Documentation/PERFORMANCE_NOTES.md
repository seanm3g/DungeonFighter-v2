...
- **Startup Time**: ~2-3 seconds of hidden preload (JSON + first title frame); the main window appears only after that frame is painted, so the title idle does not hitch on first show
